...
ha.mqtt.subscribe(`${DEVICE_PREFIX}/state`, (topic, payload) => {
  ...
  if (payload.temperature !== undefined) ha.update('sensor.mydevice_temperature', payload.temperature);

  if (payload.humidity !== undefined) ha.update('sensor.mydevice_humidity', payload.humidity);
});
