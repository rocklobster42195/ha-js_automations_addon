...
class JSAutomationsSelect(SelectEntity, RestoreEntity):
    ...
    async def async_select_option(self, option: str) -> None:
        ...
        self.hass.bus.async_fire(f"{DOMAIN}_event", {"entity_id": self.entity_id, "unique_id": self._attr_unique_id, "action": "select_option", "value": option})