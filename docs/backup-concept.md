...
1.  **Auto-Backup Strategie:**
    - _Deaktiviert_
    - _Täglich:_ (Cron-Job, z.B. 03:00 Uhr).
    - _Bei Änderung:_ Trigger beim Speichern eines Skripts (mit Debounce, z.B. max. 1x pro Stunde).
...
3.  **Inhalt:**
    ...
    - _Warnung:_ "⚠️ Secrets im Store werden unverschlüsselt in der ZIP-Datei gespeichert."
...
2.  **Sicherheits-Backup (Pre-Restore):**
    - Automatisches Erstellen eines Snapshots des _aktuellen_ Zustands vor dem Überschreiben.
3.  **Shutdown:**
