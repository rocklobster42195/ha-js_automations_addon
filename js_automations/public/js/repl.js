...
function _buildSnippetDropdown() {
  ...
  const registry = typeof SNIPPET_REGISTRY !== 'undefined' && Array.isArray(SNIPPET_REGISTRY) ? SNIPPET_REGISTRY : [];
...
function _initReplEditor() {
  ...
  _replEditor.addCommand(monaco.KeyMod.CtrlCmd | monaco.KeyCode.Enter, () => runRepl());
