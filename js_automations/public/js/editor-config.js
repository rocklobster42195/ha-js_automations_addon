    ...
    monaco.languages.registerCompletionItemProvider(lang, {
      ...
      provideCompletionItems: function (model, position) {
        ...
        if (
          ...
          const icons =
            typeof mdiIcons !== 'undefined' && mdiIcons.length > 0
              ? mdiIcons
              : [
                  'account',
                  'home',
    ...
    monaco.languages.registerCompletionItemProvider(lang, {
      ...
      provideCompletionItems: function (model, position) {
        ...
        if (textUntilPosition.match(/ha\.callService\(\s*['"](?:[^'"]*)$/)) {
          ...
          const domains =
            typeof haData !== 'undefined' && haData.services && Object.keys(haData.services).length > 0
...
async function configureMonaco() {
  ...
  try {
    ...
    typings.forEach((lib) => {
      monaco.languages.typescript.javascriptDefaults.addExtraLib(lib.content, `file:///${lib.filename}`);
    });
