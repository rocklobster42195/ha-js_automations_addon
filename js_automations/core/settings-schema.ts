...
const settingsSchema: SettingSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        key: 'github_enabled',
        label: 'settings.versioning.github_enabled',
        description: 'settings.versioning.github_enabled_desc',
        type: 'boolean',
        default: false,
      },
      {
        key: 'github_repo_url',
        label: 'settings.versioning.github_repo_url',
        type: 'text',
        default: '',
      ...
      {
        key: 'github_token',
        label: 'settings.versioning.github_token',
        description: 'settings.versioning.github_token_desc',
        type: 'text',
        mode: 'password',
        default: '',
        condition: { key: 'github_enabled', value: true },
