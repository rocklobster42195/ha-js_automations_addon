...
const settingsSchema: SettingSection[] = [
  ...
  {
    id: 'versioning',
    label: 'settings.sections.versioning',
    ...
    items: [
      {
        ...
        label: null,
        type: 'info',
        text: 'settings.versioning.about_hint',
      },
      {
        key: 'author_name',
        label: 'settings.versioning.author_name',
        type: 'text',
        default: 'JS Automations',
      },
      {
        key: 'author_email',
        label: 'settings.versioning.author_email',
        type: 'text',
        default: '',
      },
      {
        key: 'git_enabled',
        label: 'settings.versioning.git_enabled',
        description: 'settings.versioning.git_enabled_desc',
        type: 'boolean',
        default: false,
      },
      {
        key: 'git_repo_url',
        label: 'settings.versioning.git_repo_url',
        type: 'text',
        default: '',
        condition: { key: 'git_enabled', value: true },
      },
      {
        key: 'git_token',
        label: 'settings.versioning.git_token',
        description: 'settings.versioning.git_token_desc',
        type: 'text',
        mode: 'password',
        default: '',
        condition: { key: 'git_enabled', value: true },
